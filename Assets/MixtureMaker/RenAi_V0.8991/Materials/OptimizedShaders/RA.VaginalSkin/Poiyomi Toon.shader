Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/290fa97ab0fe9264bac70b59a584636d"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.7379237,0.1844743,0.1844743,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(0.7379237,0.1844743,0.1844743,1).a;
				if (2.0)
				{
					#if defined(PROP_ALPHAMASK) || !defined(OPTIMIZER_ENABLED)

Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/a0b3117b4d9d89a409f99c17a00abf24"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				float4 outlineColor = float4(0.002920729,0.002920729,0.002920729,1);
				#ifdef POI_AUDIOLINK
				if (0.0 && poiMods.audioLinkAvailable)
				{

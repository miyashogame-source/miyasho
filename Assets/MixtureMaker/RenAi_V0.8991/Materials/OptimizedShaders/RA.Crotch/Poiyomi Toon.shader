Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Toon/789258172d97a96409580e9420fa2247"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyBackFaceColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				{
					float4 backFaceColor = float4(0.1269849,0.0914508,0.1507121,1);
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				float4 outlineColor = float4(0.3058582,0.06283142,0.06283142,1);
				#ifdef POI_AUDIOLINK
